...
config_lists = {
    'aws-from-paris/@.toml': {'label': 'Replicas Closest to Paris', 'marker': 'x', 'color': blue},
    'aws-random/@.toml': {'label': 'Random Replicas', 'marker': 'o', 'color': green},
}
...
legends = [
    Line2D([0], [0], **cl_style)
    for cl_style in config_lists.values()
]

fig.legend(handles=legends, bbox_to_anchor=(0.1, 1.29, 0.85, 0.01),
